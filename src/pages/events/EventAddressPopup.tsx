...
interface EventAddressPopupProps {
  open: boolean;
  onClose: () => void;
  onSave: (id: number | null, data: Omit<EventAddress, "id">) => Promise<void>;
  address: EventAddress | null;
}

const EventAddressPopup: React.FC<EventAddressPopupProps> = ({ open, onClose, onSave, address }) => {
  ...
  const handleSubmit = async () => {
    ...
    const data: Omit<EventAddress, "id"> = {
      street: street,
      zip_code: zipCode,
      city_id: cityId || 0,
...
export default EventAddressPopup;

...
import { getTop5Cities } from '../../services/EventService';
...
const BarChart3 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await getTop5Cities();
        ...
        setChartData({
          ...
          datasets: [
            {
              label: 'Top 5 Cities with Most Events',
              data: counts,
              backgroundColor: [
        ...
        <CardContent>
          <Bar
            ...
            options={{
              ...
              plugins: {
                legend: { position: 'top' },
                title: { display: true, text: 'Top 5 Cities with Most Events', font: { size: 28 }, color: 'rgb(117, 29, 136)' },
              },
            }}
          />
        </CardContent>

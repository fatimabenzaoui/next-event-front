...
import { getEventsBySchool } from '../../services/EventService';
...
const BarChart4 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await getEventsBySchool();
        ...
        <CardContent>
          <Bar
            ...
            options={{
              ...
              plugins: {
                legend: { position: 'top' },
                title: { display: true, text: 'Number of Events per School', font: { size: 28 }, color: 'rgb(117, 29, 136)' },
              },
            }}
          />
        </CardContent>
